  ...
  <div class="card w-full bg-base-100 border-2 border-base-300">
    <div class="card-body">
      ...
      <div class="mt-6 flex flex-col gap-4">
        <h3 class="card-title text-4xl tracking-tight">
          Protect Yourself from Scams
        </h3>
        <p class="text-lg text-balance">
          Fraudsters often use spoofed websites—fake sites which copy an
    ...
    <div class="card-body">
      ...
      <div class="mt-6 flex flex-col gap-4">
        ...
        <a
          ...
          class="link text-lg font-semibold py-2 underline-offset-8"
        >
